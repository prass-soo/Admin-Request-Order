        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h4 mb-4 text-gray-800">Daftar Permintaan Berhasil</h1>
                                                                ...
                                                                <div class="images">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex justify-content-center">
                                                                            <a href="../dashboard-admin-sp/hapus.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin Untuk Di Hapus?');" class="btn btn-danger">
